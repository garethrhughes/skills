...
>
> Example: "TypeScript + NestJS + Next.js monorepo. CLAUDE.md was generated by an
> earlier version of `project-onboard` and references the v1 monolithic `RULES.md`
> only. We use OpenCode (`.opencode/skills/`) and Claude Code (`.claude/agents/`) —
> both need to be refreshed after the upgrade."
